...
public class HeatFuelingProcessPartCommonSystem extends BaseComponentSystem {
     ...
     *
     * @param event The event corresponding to a request sent to get the duration of fuel consumption The value
     *         of the duration will be added to this event by the method
